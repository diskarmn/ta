    ...
    <div class="container-fluid content-add p-4">
        <header>
            <div class="d-flex flex-row gap-4 p-5 align-items-center ">
                ...
                <h2 class="mb-0 fw-bold ">Tambah CEO</h2>
            </div>
        </header>
        <main class="bg-white ">
            <div class="p-5">
                ...
                <form action="{{ route('tambahceo') }}" method="POST"  enctype="multipart/form-data"
                class="needs-validation" id="tambahForm" novalidate>
                   ...
                   <div class="mb-3">
                       <label for="gambar" class="col-form-label">Unggah Foto </label>

...
@section('konten')
    <div class="container-fluid p-4">
        ...
        <form method="POST" id="formDataPelanggan" action="{{ route('editorders', $nomer_order) }}">
    ...
    {{-- // @foreach ($orderan as $order)
    //     <div class="modal fade" id="modalSearch{{ $order->customer->id }}" data-bs-backdrop="static"
    ...
    //                     <form action="{{ route('customer.update', $order->id) }}" method="POST" id="customerUpdate">
    //                         @csrf
    //                         @method('PUT')
    //                         <div class="mb-4 ">
    ...
    //                         <div class="mb-4 ">
    //                             <label for="tanggalRegistrasi" class="form-label label-order mb-1">Tanggal
    //                                 Registrasi</label>
    //                             <input type="text" class="form-control form-control-lg  input-custom shadow"
    //                                 id="tanggalRegistrasi" name="register_date" value="{{ date('Y-m-d') }}" required
    //                                 readonly>
    ...
    //                         <div class="mb-4">
    //                             <label for="namaPelanggan" class="form-label label-order mb-1">Nama
    //                                 Pelanggan</label>
    //                             <input type="text" name="name" value="{{ $order->customer->name }}"
    //                                 class="form-control form-control-lg input-custom shadow" id="namaPelanggan">
    //                             <div class="invalid-feedback">
    ...
    //                                 <input type="telp" name="phone" value="{{ $order->customer->phone }}"
    //                                     minlength="10" maxlength="13"
    //                                     class="form-control form-control-lg  input-custom shadow " id="hp"
    //                                     oninput="this.value = this.value.replace(/\D/g, '')" required>
    //                             </div>
    //                             <div class="col-md-6 mb-4 " id="tambah-hp-2">
    //                                 <label for="hp2" class="form-label label-order mb-1">HP 2 (Optional)
    //                                 </label>
    //                                 <input type="telp" name="phone2" value="{{ $order->customer->phone2 }}"
    //                                     minlength="10" maxlength="13"
    ...
    //                             <input type="email" name="email" value="{{ $order->customer->email }}"
    ...
    //                                 rows="3" required>{{ $order->customer->address }}</textarea>
    //                             <div class="invalid-feedback">
    //                                 Masukkan alamat
    //                             </div>
    //                         </div>
    ...
    //                                 onclick="editPelanggan()">Simpan</button>
    //                         </div>
    //                     </form>
    //                 </div>
    //             </div>

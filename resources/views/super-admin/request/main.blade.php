                    ...
                    <ul class="list-group list-group-flush">
                        @foreach ($requests as $request)
                            <li class="list-group-item unread d-flex justify-content-between align-items-center"
                                ...
                                <a href="{{ route('super-admin.request.detail', ['order_number' => $request->order->order_number]) }}"
                ...
                <div class="modal-content ">
                    ...
                    <div class="modal-footer d-flex row justify-content-start gap-2 border-top-0 m-4 p-0">
                        ...
                        <div class="d-flex gap-3 justify-content-end p-0 m-0">
                            <form action="{{ route('super-admin.requestEdit.ditolak', $order->order_number) }}"
                                method="POST">
                                @csrf
                            ...
                            <form action="{{ route('super-admin.requestEdit.kerequest', $order->order_number) }}"
                                method="POST">
                                @csrf
...
@section('js')
    <script>
        ...
        function localsave() {
            // localStorage.setItem('someFixedKey', 'abc');
            var idlogin = document.querySelector('.idlogin').innerText;
            // localStorage.setItem('idakun_' , idlogin );
    ...
    <script>
        ...
        function handleModal(orderNumber) {
            ...
            var modalUrl = '/super-admin/request/' + orderNumber + '/detail';

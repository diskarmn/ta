    ...
    <section class="container-fluid p-4">
        ...
        @if ($data_barang->count())
            <article class="d-flex flex-column rounded-top my-3 bg-white overflow-hidden ">
                ...
                <div class="kanan d-flex justify-content-end p-3">{{ $data_barang->links() }}</div>
...
@else
    <h3 class="text-center fs-4 mt-3">Barang tidak ditemukan .</h3>
    @endif
    {{-- Modal Tambah Barang --}}
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body m-3 mt-0 pt-0 pb-3">
                    <form method="POST" id="tambahForm" action="{{ route('addBaranginSA') }}">
                        @csrf
                        <div class="mb-4">
        ...
        <div class="modal fade" id="editBarangModal{{ $data->id }}" tabindex="-1" aria-labelledby="editModalLabel"
            ...
            <div class="modal-dialog modal-lg" id="isikan-form">
                <div class="modal-content">
                    ...
                    <div class="modal-body m-3 mt-0 pt-0 pb-3">
                        <form id="updateForm" action="{{ route('updateBaranginSA', $data->id) }}"
                    ...
                    <div class="my-5">
                        <div class="d-flex flex-column justify-content-center ">
                            <img src="{{ asset('assets/img/confirm.png') }}" alt="" width="120px"
                                class="mx-auto">
                            <p class="fw-bold text-center my-3 fs-5">Yakin Hapus Data ?</p>
                        </div>
                        <div class="d-flex justify-content-center gap-3">
                            <form id="deleteForm" action="{{ route('deleteBaranginSA', $data->id) }}"

                            ...
                            <div class="modal-body">
                                <div class="d-flex flex-row justify-content-between">
                                    <div class="mb-3 col-5">
                                        <label for="kurir" class="col-form-label">jasa ongkir</label>
                                        <input type="text" readonly class="form-control custom-input" id="ongkir"
                                            name="kurir" value="{{ $kurir }}">
                                    </div>
                                    <div class="mb-3 col-5">
                                        <label for="ongkir" class="col-form-label">Ongkir</label>
                                        <input type="number" readonly class="form-control custom-input" id="ongkir"
                                            name="ongkir" value="{{ $ongkir }}">
                                    </div>

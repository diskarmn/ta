<div class="wadah wadah-nav   d-flex justify-content-center flex-column">
    <div class="d-flex justify-content-between atas" style="">
        ...
        <div class="d-flex flex-row justify-content-around mx-1">
            <form action="{{ route('filterJuragan') }}" method="GET">
    ...
    <div id="button-orderan" class=" d-flex row justify-content-center bawah  w-100">
        <a id="btn-semua-orderan" href="{{ route('semua-orderan') }}"
            ...
            style="width: 220px; margin-left:50px; height:45px; font-size:18px;">Semua Status<span
                class="badge text-bg-danger ms-3 rounded-circle px-2 py-1 badge-qty">
                {{ $status['jumlah_id'] }}</span></a>
        <a id="btn-belum-proses" href="{{ route('belum-proses-orderansa') }}"
        ...
        <a id="btn-cek-pembayaran" href="{{ route('menunggu-dicek-orderansa') }}"
        ...
        <a id="btn-dalam-proses" href="{{ route('dalam-proses-orderansa') }}"
        ...
        <a id="btn-orderan-selesai" href="{{ route('orderan-selesaisa') }}"
    ...
    <div class="modal-dialog modal-lg"> <!-- Menambahkan class modal-lg -->
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="searchForm" method="GET" action="{{ route('searchinSA') }}">
                    <div class="d-flex">
                        <div class="mb-3 me-3">

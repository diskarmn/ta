...
<nav class="navbar navbar-expand-lg p-0" style=" background-color: #202B46; max-width: 100%;">
    <div class="container-fluid" style="padding: 12px 0 12px 0;">
        <div>
        ...
        <div class="navbar-nav flex-row  me-auto mx-3 mb-2 mb-lg-0">
            <li class="nav-item" style="color:#828282; font-family: 'Poppins'; font-size:16px;">
                <a class="nav-link " style="color:#828282;" href="#">Dashboard</a>
            </li>
            <li class="nav-item mx-3">
                <a class="nav-link " style="color:#828282; font-size:16px;" href="/superadmin/tulis-orderan">Tulis Orderan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " style="color:#828282; font-size:16px;"  href="#">Charts</a>
            </li>
        </div>

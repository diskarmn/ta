...
@section('konten')
    <div class="container-fluid p-4">
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <div class="col text-start align-self-start mt-3 px-3"style="max-width: 230px;">
                            ...
                            <div class="d-flex justify-content-end mt-auto">
                                <button class="btn btn-sm btn-outline-danger rounded-pill px-3 py-2 mx-2"
                                    data-bs-toggle="modal" data-bs-target="#modalEdit{{ $detailData->id }}">Edit <i
            ...
            <div class="d-flex justify-content-center bg-white">
                <div class=" d-flex  gap-4 flex-column col-xl-9 col-lg-10 col-md-11 bg-white border rounded mt-2 p-4">
                    <div class="d-flex gap-4 align-items-center ">
                        <a class="text-decoration-none" href="{{ route('dataPelangganSA') }}"><i
            ...
            <div class="d-flex justify-content-center bg-white ">
                <a class="btn btn-blue my-4 px-4 py-2 " href="{{ route('dataRiwayatTransaksiSA', $detailData->id) }}">Riwayat Transaksi</a>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body m-3 mt-0 py-0">
                        <form action="{{ route('editPelangganSA', $detailData->id) }}" method="POST" id="editFormPelanggan">
                            @csrf
                            @method('PUT')
                            {{-- <div class="mb-4 ">

...
@section('konten')
    <div class="container-fluid p-4">
        <div class="bg-white ">
            ...
            <div class="d-flex justify-content-center bg-white">
                <div class="col-lg-10 col-xl-9 col-md-11  bg-white border rounded mt-2 mb-4  ">
                    <div class="mt-3 mb-4">
                        <span>
                            <a href="{{ route('dataPelangganDetailSA', $dataTransaksi->id) }}"
                        ...
                        <div class="d-flex flex-column m-3 gap-3">
                            <div class="d-flex justify-content-between "
                                ...
                                <div class="d-flex align-items-center justify-content-center gap-3 mx-4">
                                    <a href="{{ route('super-admin.dashboard-invoice.invoice', $orderNumber) }}"
        ...
        {{-- modal tambah poin --}}
        <form action="{{ route('add-pointsSA', ['id' => $dataTransaksi->id]) }}" method="POST">
            @csrf

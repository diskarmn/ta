...
@section('konten')
    <section class="container-edit_profile rounded">
        ...
        <form action="{{ route('editPasswordAction', $data->id) }}" method="POST" id="editPasswordForm">
            @csrf
            <article class="bg-white py-5 body-edit_profile d-flex justify-center align-items-center">
                    ...
                    <div class="row py-4">
                        <div class="col-lg-12 row py-4 mx-0">
                            ...
                            <div class="col-lg-12 p-0 d-flex justify-content-between password-toggle gap-3">
                                <input
                                    class=" w-100 m-0 px-3 py-lg-3 py-md-3 rounded border border-2 rounded current-password"
                        ...
                        <div class="col-lg-12 row py-4 mx-0">
                            ...
                            <div class="col-lg-12 p-0 d-flex justify-content-between password-toggle gap-3">
                                <input class=" w-100 m-0 px-3 py-lg-3 py-md-3 border border-2 rounded" type="password"
                                    placeholder="Ulangi Password Baru" id="confirmPasswordInput" name="new_password_confirmation">
                                <button
                                    class="toggle-password btn btn-hides rounded py-2 px-lg-3 px-3 d-flex align-items-center border border-2 rounded"
                                    style="box-shadow: 4px 4px 8px rgba(0, 0, 0, 0.25);" type="button" id="showPassword"><i
                                        class="fa-regular fa-eye text-muted m-0 p-0 "></i></button>
                ...
                <div class="d-flex gap-5 btn-edit_save my-5">
                    ...
                    <button type="submit" class="btn btn_simpan-edit" onclick="editPasswordAdmin()">Simpan</button>
                </div>
            </article>
        </form>
    </section>
    ...
    <script>
        ...
        // function hashCurrentPassword() {
        //     var currentPassword = document.querySelector(".current-password").value;
        //     var hashedPassword = sha256(
        //         currentPassword); // Menggunakan fungsi hashing SHA-256 yang sudah didefinisikan sebelumnya
        //     document.querySelector(".current-password").value = hashedPassword;
        //     console.log(hashedPassword); // Mengganti nilai input dengan nilai yang sudah di-hash
        // }
        ...
        (function() {
            ...
            var forms = document.getElementById('editPasswordForm');
        ...
        function showSuksesModalAdmin() {      
            ...
            setTimeout(function() {
                ...
                window.location.href = '/super-admin/data-admin';
            }, 1200);
        }

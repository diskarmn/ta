...
@section('konten')
    <div class="container-fluid p-4">
        <div class="body-reqEdit flex-column p-4 " style=" border: 1.5px solid black; border-radius: 10px;">
            <form method="POST" id="formDataPelanggan" action="{{ url('super-admin/tulisOrderan/keorders') }}">
                @csrf
                {{-- info req --}}
                    ...
                    <div class="col">
                        ...
                        <select class="form-select form-select-lg shadow" id="opsi-juragan" name="juragan_f">
                            ...
                            @foreach ($juragan as $juragannya)
                                <option value="{{ $juragannya->id }}" data-name="{{ $juragannya->name_juragan }}">
                                    {{ $juragannya->name_juragan }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col">
                        <label for="opsi-orderan" class="label-order mb-0">Sumber </label>
                ...
                <div class="d-flex col-lg-6 flex-column mb-4">
                    ...
                    <div class="input-group rounded bg-white shadow rounded" id="data-pelanggan">
                        <input type="text" class="form-control border-0 rounded m-1 text-capitalize text-muted"
                            placeholder="Cari Pelanggan" selected style="font-family: montserrat;" id="pelanggan" readonly
                            value="">
                                        ...
                                        <tr class="text-center small border border-0  border-bottom tr-harga"
                                            ...
                                            <td class="col py-3 harga-satuan" id="harga-satuan">
                                                ...
                                                <input type="hidden" readonly class="form-control input-custom shadow"
                                                    id="inputpoint" name="point_v[]" value="{{ $isi->point }}">
                                            </td>
                                            </td>
                                        ...
                                        @foreach ($ongkir as $item)
                                            <tr class="text-center small  border-bottom" id="subtotal">
                                                ...
                                                <td class="col py-3 ongkirnya">
                                                    <input type="hidden" name="jasa_ongkir"
                                                        value="{{ $item->jasa_ongkir }}">
                                                    {{ $item->jasa_ongkir }}
                                                </td>
                                        ...
                                        @foreach ($biaya_lain as $item)
                                            <tr class="text-center small " id="subtotal">
                                                ...
                                                <td class="col py-3 biaya-lain">
                                                    <input type="hidden" name="jasa_biaya_lain"
                                                        value="{{ $item->jasa_biaya_lain }}">
                                                    {{ $item->jasa_biaya_lain }}
                                                </td>
                ...
                <div class=" d-flex gap-3">
                    ...
                    <button  type="button"  class="btn btn-danger py-2 px-5"  data-bs-toggle="modal" data-bs-target="#batal">Batal</button>
...
<div class="modal fade" id="batal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" id="batal" action="{{ url('super-admin/tulisOrderan/bataltulis') }}">
                @csrf
                @method('DELETE')
                <p>{{ $id_lokal }}</p>
                <br>
                @php
                    $keranjangs = DB::table('keranjangs')->where('employee_id', $id_lokal)->get();
                @endphp
                <div class="d-flex flex-column">
                    @foreach ($keranjangs as $isik)
                        <input type="text" name="kdk[]" value="{{ $isik->kd }}" class="form-control">
                        <input type="number" name="qtyk[]" value="{{ $isik->qty }}" class="form-control">
                    @endforeach
                </div>
                <button type="submit" class="btn btn-danger py-2 px-5"  data-bs-dismiss="modal">Batal</button>
            </form>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body m-3 py-0">
                    ...
                    <form method="POST" id="formongkir" action="{{ url('super-admin/tulisOrderan/ongkir') }}">
                        @csrf
                        <div class="mb-4 ">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body m-3 py-0">
                        ...
                        <form method="POST" id="formongkir"
                            action="{{ url('super-admin/tulisOrderan/editongkir/' . $item->id) }}">
                            @csrf
                            <div class="mb-4 ">
                                <label for="ongkir-nominal" class="form-label h6 mb-1">Nominal</label>
                ...
                <div class="modal-content bg-white">
                    ...
                    <div class="modal-body m-3 py-0">
                        <form method="POST" id="formhapusongkir"
                            action="{{ url('super-admin/tulisOrderan/deleteongkir/' . $item->id) }}">
                            @csrf
                            @method('DELETE')
    ...
    <div class="modal fade" id="Modalbiayalain" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body m-3 py-0">
                    <form method="POST" id="formbiayalain" action="{{ url('super-admin/tulisOrderan/lain') }}">
                        @csrf
                        <div class="mb-3 ">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body m-3 py-0">
                        <form method="POST" id="formbiayalain"
                            action="{{ url('super-admin/tulisOrderan/editlain/' . $item->id) }}">
                            @csrf
                            <div class="mb-3 ">
                                <label for="costnominal" class="form-label h6 mb-1">Nominal</label>
                                <input type="number" class="form-control form-control-lg input-custom shadow mb-2"
                ...
                <div class="modal-content bg-white">
                    ...
                    <div class="modal-body m-3 py-0">
                        <form method="POST" id="formhapusbiayalain"
                            action="{{ url('super-admin/tulisOrderan/deletelain/' . $item->id) }}">
                            @csrf
                            @method('DELETE')
    ...
    <div class="modal fade " id="addOrder" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" id="tambahForm" action="{{ url('super-admin/tulisOrderan/keranjang') }}">
                    @csrf
                            ...
                            <div class="d-flex flex-row justify-content-between gap-4  mb-4">
                                    ...
                                    <select required class="form-select shadow" name="kd" id="kd_produk">
                                        ...
                                        @foreach ($kda as $item)
                                            <option value="{{ $item->id }}" data-harga="{{ $item->harga_satuan }}"
                                                ...
                                                onclick="harga()">
                                                {{ $item->kd_produk }}-{{ $item->nama }}({{ $item->size }})
                                            </option>
                                        @endforeach
                                ...
                                <div class="col">
                                    ...
                                    <input required type="number" name="qty"
                                        class="form-control input-custom shadow" id="qty" min="0">
                                </div>
        ...
        <div class="modal fade " id="editOrder{{ $isi->id }}" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ url('super-admin/tulisOrderan/editkeranjang/' . $isi->id) }}">
                        @csrf
                        <div class="modal-body m-3 py-0">
                            <div class="d-flex flex-row justify-content-between gap-4  mb-4">
                                <div class="col">
                                ...
                                <div class="col">
                                    @php
                                        $barang = DB::table('barangs')
                                            ...
                                            ->first();
                                    @endphp
                                    <label for="qty" id="labelqty_edit" class="form-label label-order mb-1">QTY
                                        max:{{ $barang->stock }}</label>

                                    <input type="number" name="qty_edit" class="form-control input-custom shadow"
                                        id="qty_edit" value="{{ $isi->qty }}" min="0"
                                        max="{{ $barang->stock }}">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content bg-white">
                    ...
                    <div class="modal-body m-3">
                        <form method="POST" id="formhapusbiayalain" action="{{ route('hapusordersa', $isi->id) }}">
                            @csrf
                            @method('DELETE')
                            <table class="table">
                                <tr>
    ...
    <!-- Modal show cs-->
    @foreach ($cs as $data)
        <div class="modal fade modal-lg" id="showcs{{ $data->id }}" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
                ...
                <div class="modal-body m-3 py-0">
                    ...
                    <form method="POST" id="formDataPelanggan" action="{{ url('super-admin/tulisOrderan/addcs') }}">
                        @csrf
                        <div class="mb-4 ">
        ...
        <script>
            ...
            for (let i = 0; i < selek.length; i++) {
                selek[i].addEventListener("change", function() {
                    ...
                    const qtyInput = parentDiv.nextElementSibling.nextElementSibling.nextElementSibling.querySelector(
                        "#qty");
                    const labelqty = parentDiv.nextElementSibling.nextElementSibling.nextElementSibling.querySelector(
                        "#labelqty");
                    const labelukuran = parentDiv.nextElementSibling.nextElementSibling.querySelector("#label_ukuran");
                    ...
                    // labelukuran.innerHTML = `Ukuran : ${size}`;
        ...
        <script>
            ...
            function saveOrder() {
                ...
                if (berhasil) {
                    showSuksesModalEdit();
                    setTimeout(function() {
                        window.location.href = '/super-admin/semua-orderan';
                    }, 1200);
                } else {
                    showErorModalEdit();
                    setTimeout(function() {

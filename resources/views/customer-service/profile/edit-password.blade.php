    ...
    <section class="container-edit_profile rounded">
        ...
        <article class="header-edit_profile px-lg-4 px-md-5">
            <!-- <a href="/cs/profile" class="back-profile">
                <i class="fa-solid fa-arrow-left icon_back-profile m-0">
                </i>
            </a> -->
        ...
        <form method="POST" action="{{ route('cs.profile.updatePassword') }}" class="bg-white py-5 body-edit_profile d-flex justify-center align-items-center">
            @csrf
            @method('PUT')
            ...
            <div class="d-flex gap-5 btn-edit_save my-5">
                <button type="button" onclick="window.location.href='{{ route('cs.profile') }}'" class="btn btn_batal-edit">Batal</button>

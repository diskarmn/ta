<div class="wadah wadah-nav   d-flex justify-content-center flex-column  ">
    <div class="d-flex justify-content-between atas " style="">
        ...
        <div class="pojok-kanan  d-flex flex-row justify-content-around ">
            <form action="{{ route('filterJuraganinCS') }}" method="GET">
                <select id="filter-select" class="form-select mr-3 mt-3 fzt7 select-tablet" name="juragan"
                    aria-label="Default select example" style="width: 200px; border:1px solid black">
            ...
            <div class="kanan flex-row d-flex justify-content-around align-items-center "
                ...
                <a id="cari-orderan"
                    ...
                    data-bs-target="#exampleModal4">Cari Orderan</a><i style="margin-left:10px; margin-right:50px;"
    ...
    <div id="button-orderan" class=" d-flex row justify-content-center bawah w-100">
        <a id="btn-semua-orderan" href="{{ route('semua-orderanCS') }}"
            class="btn tablet-menu fzt8 rounded-4 me-3 text-center btn-orderan py-2 col-lg-2  {{ request()->routeIs('semua-orderanCS') ? ' aktif' : '' }}"
        ...
        <a id="btn-belum-proses" href="{{ route('belum-proses-orderanCS') }}"
            class="btn tablet-menu  fzt8 rounded-4 ms-3 me-4 text-center btn-orderan py-2 col-lg-2  {{ request()->routeIs('belum-proses-orderanCS') ? ' aktif' : '' }}"
        ...
        <a id="btn-cek-pembayaran" href="{{ route('menunggu-dicek-orderanCS') }}"
            class="btn  tablet-menu fzt8 rounded-3 ms-4 me-3 text-center btn-orderan py-2 col-lg-2  {{ request()->routeIs('menunggu-dicek-orderanCS') ? ' aktif' : '' }}"
        ...
        <a id="btn-dalam-proses" href="{{ route('dalam-proses-orderanCS') }}"
            class="btn  tablet-menu fzt8  rounded-3 ms-4 me-3 text-center btn-orderan py-2 col-lg-2 {{ request()->routeIs('dalam-proses-orderanCS') ? ' aktif' : '' }}"
        ...
        <a id="btn-orderan-selesai" href="{{ route('orderan-selesaiCS') }}"
            class="btn  tablet-menu fzt8 rounded-3 ms-4 text-center btn-orderan py-2 col-lg-2  {{ request()->routeIs('orderan-selesaiCS') ? ' aktif' : '' }}"
    ...
    <div class="modal-dialog modal-lg"> <!-- Menambahkan class modal-lg -->
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="searchForm" method="GET" action="{{ route('searchinCS') }}">
                    <div class="d-flex">
                        <div class="mb-3 me-3">

...
@section('konten')
    <div class="container-fluid p-4">
        <div class="bg-white ">
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <div class="col text-start align-self-start mt-3 px-3"style="max-width: 230px;">
                            ...
                            <p class="my-2" style="font-size: 22px; font-weight:300; color:#666666;">
                                {{ $dataTransaksi->registered_date }}</p>
                            <span>
            ...
            <div class="d-flex justify-content-center bg-white">
                ...
                <div class="col-lg-10 col-xl-9 col-md-10  bg-white border rounded mt-2 mb-4  ">
                    <div class="mt-3 mb-4">
                        <span>
                            <a href="{{ route('detailPelangganCs', $dataTransaksi->id) }}">
                        ...
                        <div class="d-flex flex-column m-3 gap-3">
                            <div class="d-flex justify-content-between "
                                ...
                                <div class="d-flex align-items-center justify-content-center gap-3 mx-4">
                                    <a href="{{ route('customer-service.dashboard-invoice.invoice', $orderNumber) }}"
                                        class="btn btn-purple" style="font-size: 12px;">Lihat
                                        Invoice</a>
        ...
        {{-- modal tambah poin --}}
        <form action="{{ route('add-pointsCS', ['id' => $dataTransaksi->id]) }}" method="POST">
            @csrf

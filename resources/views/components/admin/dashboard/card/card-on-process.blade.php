                ...
                <div class="my-3 d-flex align-items-center gap-5 gap_btn">
                    ...
                    <div class="row my-3 d-flex align-items-center gap_btn">
                        <a href="#"
                            ...
                            data-bs-toggle="modal"  data-bs-target="#infoPembayaranModal{{ $order['order_number'] }}">
...
{{-- @php
    $status = $filtered->status ?? 'dalam_proses';
    $currentKelengkapan = $filtered['kelengkapan'] ?? 'Belum Lengkap';
@endphp --}}
...
@if ($orderan->count())
                                    ...
                                    <div class="card-bawah-sendiri-superadmin  px-4 py-3 gap-2 row">
                                        ...
                                        @if ($data->first()->total_amount > $data->first()->paid_amount && $data->first()->status != 'cek_pembayaran')
                                            ...
                                            <div class="sunting rounded rounded-3 d-flex overflow-hidden  col-2 mx-2 px-0 justify-content-between border border-dark border-2 "
                                                ...
                                                <button class="px-3 bg-none dropdown border-none border  "
                                                    type="button" style="border-left:2px solid black !important;"
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item  fzt7"
                                                            data-value="tambah" data-bs-toggle="modal"
    ...
    @php
        $infoPembayaran = DB::table('info_pembayaran')
                            ...
                            ->get();
    @endphp
    <div class="modal fade infopembayaran" id="infoPembayaranModal{{ $orderNumber }}"
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form
                            action="{{ route('update.check.paymentsa', ['orderId' => $orderNumber]) }}"
                            method="POST">
                            @csrf
                            <p>{{ $orderNumber }}</p>
                            <p
                                ...
                                @foreach ($infoPembayaran as $info)
                                    ...
                                    <div class="d-flex flex-column parentinfo">
                                        <div class="d-flex gap-4 align-items-center justify-content-between border border-1
                                        my-2 px-3 rounded-1 border-secondary shadow">
                                            ...
                                            <div class="col-lg-4 my-2">
                                                <p
                                                    class=" fs-6 fw-medium font-family-Poppins ml-2 my-0">
                                                Rp
                                            ...
                                            <div class="col-lg-3 wadah my-2 justify-content-end d-flex">
                                                    <div class="btn-group dropend infopembayaran">
                                                        <a
                                                            class="btn border border-3 border-black px-2 dropdown rounded-2 ">
                                                            <span class="">
                                                                <svg width="14" height="4"
                                                                    style="display: ;" class="mx-1 my-2 garis"
                                                                    viewBox="0 0 11 1" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path id="Vector 1489" d="M1.5 1.5H9.5"
                                                        ...
                                                        <div class="dropdown-menu border border-dark"
                                                            ...
                                                            <p class="mx-5 my-2" style="white-space: nowrap;"
                                                                id="tidak-ada">
                                                                Tidak Ada</p>
                                                        </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <input type="text" style="z-index: -10" class="border border-none bg-none"  name="adatidak[]" id="adatidak"
                                            value=""  >
                                                ...
                                                <div class="py-2 " id="statusContainerTidak"
                                                    style="display:none ;">
                ...
                <form action="{{ route('update.on.processsa', ['orderId' => $orderId->order_number]) }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 col-lg-12">
                            ...
                            <textarea type="text" class="form-control shadow" placeholder="Opsional"
                                style="min-height: 100px !important;" name="keterangan"></textarea>
                        </div>
